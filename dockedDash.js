 ...
 * must have a WEST (SOUTH) anchor_point to achieve the sliding in the RIGHT (BOTTOM)
 * direction.
*/
...
const dockedDash = new Lang.Class({
    ...
    _init: function(settings) {
        ...
        let positionStyleClass = ['left', 'right', 'top', 'bottom'];
        // This is the centering actor
        this.actor = new St.Bin({ name: 'dashtodockContainer',reactive: false,
            style_class:positionStyleClass[this._direction],
        ...
        this._slider = new DashSlideContainer({direction: this._direction});
    ...
    _updateStaticBox: function() {
        ...
        this.staticBox.init_rect(
            this.actor.x + this._slider.x - (this._direction==Direction.RIGHT?this._box.width:0),
            this.actor.y + this._slider.y - (this._direction==Direction.BOTTOM?this._box.height:0),
            this._box.width,
            this._box.height
        );
